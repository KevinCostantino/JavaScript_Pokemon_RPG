export function initializeProgressBar(pp,progress,dano,progressBar) {
    ...
    console.log("batata",progressBar)
    ...
    // Evento para diminuir a barra
    //decreaseButton.addEventListener("click", () => {
    //  if (p > 0) {
    //    const decreaseAmount = dano; // Valor entre 10 e 30
    //    p = Math.max(p - decreaseAmount, 0); // Evita que fique abaixo de 0
    //    updateProgressBar(p,p); // Atualiza a barra com o novo valor
    //  }
    //});
//
    //// Evento para resetar a barra
    //resetButton.addEventListener("click", () => {
    //  p = 100; // Restaura para 100%
    //  updateProgressBar(p,p); // Atualiza a barra com o valor restaurado
    //});
  }
